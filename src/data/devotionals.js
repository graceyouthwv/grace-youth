export const DAILY_DEVOTIONALS = [
  {
    id: 'dev-1',
    date: 'Today\'s Word',
    theme: 'Peace Amidst College Pressure',
  ...
  },
  {
    ...
    verseTextHlg: 'Kon may isa sa inyo nga kulang sang kaalam, magpangayo sia sa Dios nga nagahatag sing maalwan sa tanan nga wala sing pagbasol, kag pagahatagan sia.',
    reflectionEn: 'When you stare at a difficult problem set or have to make a tough decision about your major or relationships, remember that God is the author of all knowledge and truth. He loves to grant you wisdom.',
    reflectionHlg: 'Kon nabudlayan ka sa imo pagtuon ukon may mabudlay nga desisyon, dumduma nga ang Ginoo amo ang tuburan sang tanan nga kaalam. Handa Sia magbulig kag magtudlo sa imo.',
    reflectionQuestion: 'How can you invite God into your study habits this week?',
    author: 'Grace Youth Campus Mission'
  }
];
