...
export const PrayerWall = () => {
  const { prayers, selectedCampus, theme } = useApp();
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-center justify-between">
        <div className="relative w-full sm:w-80">
          ...
          <input
            type="text"
            placeholder="Search prayer requests & praise..."
            value={searchQuery}
      ...
      {filteredPrayers.length > 0 ? (
        ...
        <div className={`p-12 text-center rounded-3xl border border-dashed ${
          ...
          <p className="text-xs mt-1">Be the first to post a prayer request or praise report!</p>
        </div>
      )}
